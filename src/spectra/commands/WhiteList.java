...
public class WhiteList extends Command {
    ...
    private class WLAdd extends Command {
        ...
        protected boolean execute(Object[] args, MessageReceivedEvent event) {
            ...
            lists.set(entry);
            Sender.sendResponse(SpConst.SUCCESS+entry[GlobalLists.IDTYPE]+" with ID `"+id+"` ("+guild.getName()+") added to whitelist", event);
            return true;
        }
    }
    ...
    private class WLList extends Command {
        ...
        protected boolean execute(Object[] args, MessageReceivedEvent event) {
            ...
            lists.getWhitelist().stream().forEach((str) -> {
                builder.append("\n").append(str);
            });
